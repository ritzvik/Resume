...
\cvevent{CBSE (Matriculation \& Higher Secondary)}{D.A.V Public School}{2014-2016}{Shrestha Vihar, Delhi}
\begin{itemize}
    \item X - 10/10 (CGPA) \&   XII - 94.4\%
\end{itemize}
...
\cvproject{\href{https://github.com/ritzvik/PageRank}{Hadoop Map-Reduce implementation of PageRank and Content-based filtering}}
\begin{itemize}
...
\cvproject{\href{https://github.com/ritzvik/DL-Video-Colorization}{Video colorization using Deep Learning}}
\begin{itemize}
